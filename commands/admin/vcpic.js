...
const IMAGE_MODEL = process.env.HORDE_IMAGE_MODEL; // Left undefined by default so any active worker picks it up
...
async function generateImage(prompt) {
  ...
  // Bumped timeout limit to 4 minutes (240 seconds)
